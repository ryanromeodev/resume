...
# Approach
This thesis introduces a system-level co-design methodology to resolve this issue. The idea is to generate a comprehensive data basis by running a large number of simulations across a range of motor geometries and inverter switching parameters. This dataset is then used to train a surrogate machine learning regressor model that can predict the performance of electric drive systems. By integrating this trained surrogate model into the optimization loop, the proposed framework is intended to accelerate the process, allowing for the concurrent optimization of motor geometry and inverter switching parameters to maximize the overall performance of the UAV electric drive system.
